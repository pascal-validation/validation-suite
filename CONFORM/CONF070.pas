...
{                                                                    }
{ TEST 6.4.3.5-6, FILE=CONF070, CLASS=CONFORMANCE, LEVEL=0           }
{                                                                    }
...
{ of test procedures. This test involves structured types.           }
{                                                                    }
...
begin
   ...
   Unions;
   if result=pass then
      writeln(' PASS...6.4.3.5-6 (CONF070)')
   else
      writeln(' FAIL...6.4.3.5-6 (CONF070)')
end.
