...
{                                                                    }
{ TEST 6.4.3.5-8, FILE=CONF072, CLASS=CONFORMANCE, LEVEL=0           }
{                                                                    }
...
{ of test procedures. This test involves packed unstructured types.  }
{                                                                    }
...
begin
   ...
   SubrangeOfInteger;
   if result=pass then
      writeln(' PASS...6.4.3.5-8 (CONF072)')
   else
      writeln(' FAIL...6.4.3.5-8 (CONF072)')
end.
