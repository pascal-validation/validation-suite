...
{                                                                    }
{ TEST 6.4.3.5-7, FILE=CONF071, CLASS=CONFORMANCE, LEVEL=0           }
{                                                                    }
...
{ of test procedures. This test involves pointer types.              }
{                                                                    }
...
begin
   ...
   if result=pass then
      writeln(' PASS...6.4.3.5-7 (CONF071)')
   else
      writeln(' FAIL...6.4.3.5-7 (CONF071)')
end.
